...
d-i preseed/late_command string wget -O /target/lib/systemd/system/wisnuc-installer.service \
  https://raw.githubusercontent.com/wisnuc/appifi-system/master/install-scripts/ubuntu-16-04-02-amd64/wisnuc-installer.service
d-i preseed/late_command string wget -O /target/usr/bin/wisnuc-installer \
  https://raw.githubusercontent.com/wisnuc/appifi-system/master/install-scripts/ubuntu-16-04-02-amd64/wisnuc-installer
